...
- **Defense Evasion: [T1140](https://attack.mitre.org/techniques/T1140/) --- Deobfuscate/Decode Files or
  Information:**  
...
- **Defense Evasion: [T1211](https://attack.mitre.org/techniques/T1211/) --- Exploitation for Defense
  Evasion:**  
...
- **Defense Evasion, Privilege Escalation: [T1134](https://attack.mitre.org/techniques/T1134/) --- Access
  Token Manipulation:**  
...
- **Defense Evasion, Privilege Escalation: [T1055](https://attack.mitre.org/techniques/T1055/) --- Process
...
- **Credential Access: [T1003.001](https://attack.mitre.org/techniques/T1003/001/) --- OS Credential Dumping:
  LSASS Memory:**  
...
- **Defense Evasion: [T1070.001](https://attack.mitre.org/techniques/T1070/001/) --- Indicator Removal: Clear
  Windows Event Logs:**  
